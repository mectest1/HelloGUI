...
public class PickOnBoundsApp extends Application {

	private CheckBox pickOnBoundsCbx = new CheckBox(Msg.get(PickOnBoundsApp.class, "checkBox"));
	@Override
...
//		group.getChildren().addAll(circle, rect);	//the circle will be overriden by the rectangle
		...
		circle.setOnMouseClicked(PickOnBoundsApp::handleMouseClickec);
		rect.setOnMouseClicked(PickOnBoundsApp::handleMouseClickec);
